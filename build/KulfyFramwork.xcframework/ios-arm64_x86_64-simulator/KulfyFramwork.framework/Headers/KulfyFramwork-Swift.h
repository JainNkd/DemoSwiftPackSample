...
#ifndef KULFYFRAMWORK_SWIFT_H
#define KULFYFRAMWORK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="KulfyFramwork",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13KulfyFramwork28KulfyDashboardViewController")
...
@interface KulfyDashboardViewController (SWIFT_EXTENSION(KulfyFramwork)) <UISearchBarDelegate>
